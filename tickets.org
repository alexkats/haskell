...
В общем, может быть такая штука как сумма типов: ~ST = T~_{1} ~+ ... + T~_{n} (по сути ~enum~ - перечисления, но это, скорее, частный случай).
Бывает произведение типов: ~PT = T~_{1} ~\times ... \times T~_{n} (частный случай - структуры в плюсах).
